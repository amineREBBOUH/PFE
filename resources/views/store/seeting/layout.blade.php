...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('css/seeting.css')}}">
</head>
<body>
			...
			<div class="bg-white shadow rounded-lg d-block d-sm-flex">
				<div class="profile-tab-nav border-right">
					...
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<a  href="{{route('store.seeting')}}" role="tab" aria-controls="account" aria-selected="true" @if (Request::is('store/seeting')) class="l2AActiv" @else class="l2A" @endif>
							<i class="fa fa-home text-center mr-1"></i> 
							Account
						</a>
						<a  href="{{route('store.password')}}" role="tab" aria-controls="password" aria-selected="false"@if (Request::is('store/seeting/password')) class="l2AActiv"@else class="l2A"@endif>
